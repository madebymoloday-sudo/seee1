...
function coreQuestion(step: number, subject: Subject, thought3?: string): string {
  ...
  switch (step) {
    case 1:
      return `Расскажите, какие ситуации происходят у вас в жизни, от которые вас беспокоят и от которых хотелось бы "Освободиться", и так же будем рады если вы поделитесь ситуациями которые для вас важны, положительно на вас влияют или ситуации которые вы хотели бы чтобы с вами произошли
